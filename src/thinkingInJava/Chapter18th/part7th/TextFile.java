...
public class TextFile extends ArrayList<String> {
    ...
    public static void main(String[] args){
        String file = read("D:\\practie\\DayliPractice\\src\\thinkingInJava.Chapter18th\\part6th\\TextFile.java");
        write("test.txt",file);
        TextFile text = new TextFile("test.txt");
        text.write("test2.txt");
        TreeSet<String> words = new TreeSet<>(new TextFile("D:\\practie\\DayliPractice\\src\\thinkingInJava.Chapter18th\\part6th\\TextFile.java","\\W+"));
