...
public class BasicFileOutput {
    ...
    public static void main(String[] args)throws IOException {
        BufferedReader in = new BufferedReader(new StringReader(BufferedInputFile.read("D:\\practie\\DayliPractice\\src\\thinkingInJava.Chapter18th\\part6th\\BasicFileOutput.java")));
        /**
